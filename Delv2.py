...
tableCSV = {
    ...
    "Standard Surgery" : ["",],
    "Arm/Group Description" : [strippedStandardSurgeryContent,],
    "Overall Number of Baseline Participants" : [strippedOverallValueOne,],
    "Baseline Analysis Population Description" : [strippedAnalysisDescValue,],
    "Age, Categorical Measure Type: Count of Participants Unit of measure:  Participants " : ["",],
    "Number Analyzed" : [strippedAgeRowOneValueTwo,],
    "<=18 years" : [strippedAgeRowTwoValueTwo,],
    " " : [strippedAgeRowTwoValueThree,],
    "Between 18 and 65 years" : [strippedAgeRowThreeValueTwo,],
    "  " : [strippedAgeRowThreeValueThree,],
    ">=65 years" : [strippedAgeRowFourValueTwo,],
    "   " : [strippedAgeRowFourValueThree,],
    "Sex, Categorical Measure Type: Count of Participants Unit of measure:  Participants " : ["",],
    "(S) Number Analyzed" : [strippedSexRowOneValueTwo,],
    "Female" : [strippedSexRowTwoValueTwo,],
    "    " :[strippedSexRowTwoValueThree,],
    "Male" : [strippedSexRowThreeValueTwo,],
    ...
    "(R) Number Analyzed" : [strippedRaceRowOneValueTwo,],
    "Empty" : [strippedRaceRowTwoValueOne,],
}
