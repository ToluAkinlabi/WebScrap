...
tableCSV = {
    ...
    "(S) Overall Number of Baseline Participants" : [strippedOverallValueOne,],
    ...
    "(S) Number Analyzed" : [strippedAgeRowOneValueTwo,],
    "(S) <=18 years" : [strippedAgeRowTwoValueTwo,],
    " " : [strippedAgeRowTwoValueThree,],
    "(S) Between 18 and 65 years" : [strippedAgeRowThreeValueTwo,],
    "  " : [strippedAgeRowThreeValueThree,],
    "(S) >=65 years" : [strippedAgeRowFourValueTwo,],
    "   " : [strippedAgeRowFourValueThree,],
    "(S) Sex, Categorical Measure Type: Count of Participants Unit of measure:  Participants " : ["",],
    "(SSex) Number Analyzed" : [strippedSexRowOneValueTwo,],
    "(S) Female" : [strippedSexRowTwoValueTwo,],
    "    " :[strippedSexRowTwoValueThree,],
    "(S) Male" : [strippedSexRowThreeValueTwo,],
    "     " : [strippedSexRowThreeValueThree,],
    "(S) Race and Ethnicity Not Collected Measure Type: Count of Participants Unit of measure:  Participants" : ["",],
    "(SRace) Number Analyzed" : [strippedRaceRowOneValueTwo,],
    "(S) Empty" : [strippedRaceRowTwoValueTwo,],

    #Column Break
    "         " : [""],

    #Standard Surgery With OOC Section
    "(SS) Standard Surgery With OOC" : ["",],
    "(SS) Arm/Group Description" : [strippedStandardSurgeryWithOOContent,],
    "(SS) Overall Number of Baseline Participants" : [strippedOverallValueTwo,],
    ...
    "(SS) Number Analyzed" : [strippedAgeRowOneValueThree,],
    "(SS) <=18 years" : [strippedAgeRowTwoValueFour,],
    "           " : [strippedAgeRowTwoValueFive,],
    "(SS) Between 18 and 65 years" : [strippedAgeRowThreeValueFour,],
    "            " : [strippedAgeRowThreeValueFive,],
    "(SS) >=65 years" : [strippedAgeRowFourValueFour,],
    "              " : [strippedAgeRowFourValueFive,],
    "(SS) Sex, Categorical Measure Type: Count of Participants Unit of measure:  Participants " : ["",],
    "(SSSex) Number Analyzed" : [strippedSexRowOneValueThree,],
    "(SS) Female" : [strippedSexRowTwoValueFour,],
    "             " :[strippedSexRowTwoValueFive,],
    "(SS) Male" : [strippedSexRowThreeValueFour,],
    "               " : [strippedSexRowThreeValueFive,],
    "(SS) Race and Ethnicity Not Collected Measure Type: Count of Participants Unit of measure:  Participants" : ["",],
    "(SSRace) Number Analyzed" : [strippedRaceRowOneValueThree,],
    "(SS) Empty" : [strippedRaceRowTwoValueThree,],
    ...
    "(T) Overall Number of Baseline Participants": [strippedOverallValueThree, ],
    ...
    "(TA) Number Analyzed": [strippedAgeRowOneValueFour, ],
    "(T) <=18 years": [strippedAgeRowTwoValueSix, ],
    "       ": [strippedAgeRowTwoValueSeven, ],
    "(T) Between 18 and 65 years": [strippedAgeRowThreeValueSix, ],
    "        ": [strippedAgeRowThreeValueSeven, ],
    "(T) >=65 years": [strippedAgeRowFourValueSix, ],
    "                 ": [strippedAgeRowFourValueSeven, ],
    "(T) Sex, Categorical Measure Type: Count of Participants Unit of measure:  Participants ": ["", ],
    "(TS) Number Analyzed": [strippedSexRowOneValueFour, ],
    "(T) Female": [strippedSexRowTwoValueSix, ],
    "          ": [strippedSexRowTwoValueSeven, ],
    "(T) Male": [strippedSexRowThreeValueSix, ],
    "                ": [strippedSexRowThreeValueSeven, ],
    "(TR) Race and Ethnicity Not Collected Measure Type: Count of Participants Unit of measure:  Participants": ["", ],
    "(T) Number Analyzed": [strippedRaceRowOneValueFour, ],
    "(T) Empty": [strippedRaceRowTwoValueFour, ],
}
